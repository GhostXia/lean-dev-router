    ...
    for relative, (name, model, effort, sandbox) in expected.items():
        ...
        role_terms = {
            "luna_worker": (
                ...
                "Execute dependency preparation only when the DISPATCH contract explicitly declares",
                "undeclared, missing, or out-of-contract tool/dependency is zero-execution",
            ...
            "sol_planner": (
                ...
                "Declare every dependency-preparation command or tool explicitly",
                "only Luna may execute that declared preparation",
            ...
            "terra_auditor": (
                ...
                "Stay read-only during technical resolution",
                "never install or invoke missing or out-of-contract tools/dependencies",
...
def validate_skill() -> None:
    ...
    validate_skill_document(
        ...
        common + (
            ...
            "deterministic `spinning`",
            "Parent never repairs/writes",
            "same revision is never",
            "Contract-declared dependency prep is Luna-only",
            "zero-execution ->",
            "`ESCALATE`/`technical_resolution`",
            "never `BLOCKED/none`",
    ...
    validate_skill_document(
        ...
        optimized_common + (
            ...
            "Contract-declared dependency preparation is Luna-only",
            "zero-execution: Luna uses",
            "`ESCALATE`/`technical_resolution`",
            "never `BLOCKED/none`",
            "`parent:pause` is zero-execution: parent must not run",
            "`npm ci`",
